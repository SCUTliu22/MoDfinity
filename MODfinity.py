class YourModel(nn.Module):
    def __init__(self, in_planes1=1, in_planes2=3, num_cls=28):
        ...
        self.cls_transformer = Class_Transformer(self.img_model.fea_dim, num_cls)
...
class LossManager:
    def __init__(self, batch_size, device):
        ...
        self.ls_lambda = 5.0  # 默认值，可以通过参数修改
        self.beta = 6.0  # 蒸馏对比损失的权重，默认值为6
    ...
    def get_label_delabel_maxtri(self, label):
        ...
        delabel_maxtri = self.ones_m - label_maxtri
        return label_maxtri, delabel_maxtri
    ...
    def compute_losses(self, model, imgs, audios, targets, modality_name=None):
        # 前向传播
        ...
        # 获取标签矩阵
        label_maxtri, _ = self.get_label_delabel_maxtri()
        ...
        total_loss = ce_img_loss+ce_audio_loss + self.beta * distill_img_mod + \
                     ce_img_loss+ce_audio_loss + self.beta * distill_audio_mod + \
